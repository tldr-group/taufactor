...
![Microstructure and flux field of a sample from the \hyperref{https://microlib.io/}{microlib.io} library [@kench2022microlib].\label{example}](example.pdf)
